...
angular.module('CCR').directive('amplitudejs', ['$window', '$q', function ($window, $q) { return new AngularAmplitudejs.AmplitudejsDirective($window, $q); }])
angular.module('CCR').service('amplitudejsService', AngularAmplitudejs.AmplitudejsService)
